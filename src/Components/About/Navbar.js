        ...
        <>
          <nav className="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li className="drop-down active"><Link to="/about">Explore!</Link>
                  <ul>
                    <li><Link to="/stories">SCM Stories</Link></li>
                    <li className="drop-down"><Link to="/about">Who We Are</Link>
                        <ul>
                          <li className="active"><Link to="/about">Our Vision</Link></li>
                          <li className="active"><Link to="/about#mission">Our Mission</Link></li>
                          <li className="active"><Link to="/about#history">Our History</Link></li>
