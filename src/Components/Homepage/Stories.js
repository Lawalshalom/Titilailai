      ...
      <div className="owl-carousel testimonials-carousel" data-aos="fade-up-right" data-aos-delay="100">
        ...
        <div className="testimonial-wrap">
          <div className="testimonial-item">
            ...
            <p>
              <i className="bx bxs-quote-alt-left quote-icon-left"></i>
              I am Oluwakemi Osunberu (nee Ero-Phillips). Course Vet. Med. Hall: IdiaSubgroup: Evangelism/Follow-upDuration of Stay: 1989/1990 to 1997 (Courtesy: ASUU Strikes)I joined SCM in...
              <i className="bx bxs-quote-alt-right quote-icon-right"></i>
            </p>
