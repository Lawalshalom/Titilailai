        ...
        <>
          <nav className="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li className="drop-down"><Link to="/about">Explore!</Link>
                  <ul>
                    ...
                    <li className="drop-down"><Link to="/about">Who We Are</Link>
                        <ul>
                          ...
                          <li className="active"><Link to="/team">Our Executive Team</Link></li>
                        </ul>
                            </li>
                ...
                <li className="active"><Link to="/team">Executives</Link></li>
